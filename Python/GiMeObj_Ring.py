...
class Obj:
    ...
    def draw_ring(self):
        ...
        This distribution represents the simplest possible case, a ring of particles with semi-major axis varying as
        a gaussian, with all other orbital parameters set to constant or random values, as appropriate.
        """

        self.comments = "Ring"

        self.a = self.gauss(48.3, 1)  # units in AU
        self.e = self.constant(0.1)
        ...
        self.peri = self.uniform(0, 2*np.pi)  # random value between 0 and 2pi # units in radians
...
def initialize():
    ...
    global obj1
    obj1 = Obj(size)
    obj1.draw_ring()  # Generate distribution.
