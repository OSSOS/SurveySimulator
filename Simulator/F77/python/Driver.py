...
# m_rand and h_rand are in discovery filter
        n_hits += 1
        f_detect.write('{:8.3f} {:6.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:6.2f} {:6.2f} {:5.2f} {:2d} {:8.3f} {:8.3f} {:6.2f} {:4.2f} {:8.5f} {:8.4f} {:6s} {:s}\n'.format(a, e, inc/drad, a*(1.-e), r, mt/drad, node/drad, peri/drad, m_rand, h_rand, color[ic-1], flag, delta, m_int, h, eff, ra/drad/15., dec/drad, conv(surna), conv(comments[0:nchar])))
        if (flag > 2) and (num.mod(flag,2) == 0):
            n_track += 1
            f_track.write("{:8.3f} {:6.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:6.2f} {:6.2f} {:5.2f} {:s}\n".format(a, e, inc/drad, a*(1.-e), r, mt/drad, node/drad, peri/drad, m_rand, h_rand, color[ic-1], conv(comments[0:nchar])))
