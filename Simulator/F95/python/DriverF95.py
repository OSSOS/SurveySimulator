...
f_detect.write(
    '#   a      e        i        q        r        M       node     peri  m_rand H_rand color flag delta    m_int    H_int eff   RA(H)     DEC    Surv. Comments\n')
...
while keep_going:
    ...
    if ierr != -10:
        ...
        flag, ra, dec, d_ra, d_dec, r, delta, m_int, m_rand, eff, isur, mt, jdayp, ic, surna, h_rand = \
            SS.detos1(o_m, epoch, h, color, gb, ph, period, amp, survey_dir, seed)
        ...
        if flag > 0:
            ...
            n_hits += 1
            f_detect.write(
                '{:8.3f} {:6.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:6.2f} {:6.2f} {:5.2f} {:2d} {:8.3f} {:8.3f} {:6.2f} {:4.2f} {:8.5f} {:8.4f} {:6s} {:s}\n'.format(
                    o_m.a, o_m.e, o_m.inc / drad, o_m.a * (1. - o_m.e), r, mt / drad, o_m.node / drad, o_m.peri / drad, m_rand, h_rand,
                    color[ic - 1], flag, delta, m_int, h, eff, ra / drad / 15., dec / drad, conv(surna), conv(commen[0:nchar])))
            if (flag > 2) and (num.mod(flag, 2) == 0):
                n_track += 1
                f_track.write(
                    "{:8.3f} {:6.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:8.3f} {:6.2f} {:6.2f} {:5.2f} {:s}\n".format(o_m.a,
                                                                                                                            o_m.e,
                                                                                                                            o_m.inc / drad,
                                                                                                                            o_m.a * (
                                                                                                                                        1. - o_m.e),
